...
let guestCantMake = "mahrukh";
console.log("\nUnfortunately" ,(guestCantMake.replace (/\b\w/g, (pupil) => (pupil.toUpperCase()))), "can't make to come for the dinner.")
